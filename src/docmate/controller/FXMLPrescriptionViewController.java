                ...
                try {
                    ...
                    if (connection != null) {
                        ...
                        while (resultSet.next()) {
                            ...
                            patientMedicine.setDosage(resultSet.getString("DrugDosages"));
                            patientMedicine.setDuration(resultSet.getString("DrugDuration"));
                            patientMedicine.setAdvice(resultSet.getString("DrugAdvice"));
                        ...
                        div(h1("Rx"),
                                ol(each(patientMedicineObservableList, patientMedicine -> tr(
                                        li(i(patientMedicine.getDosageForm() + " "),
                                                ...
                                                ul(
                                                        li(patientMedicine.getDosage()
                                                                + " - " + patientMedicine.getDuration()
                                                        ).withStyle("list-style: none"),
                                                        li(patientMedicine.getAdvice()
                                                        ).withStyle("list-style: none")
