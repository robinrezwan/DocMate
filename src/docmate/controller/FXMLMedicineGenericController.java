...
public class FXMLMedicineGenericController implements Initializable {
    ...
    public void setSearchUtility(TextField searchMedicineField, Button searchMedicineButton) {
        this.searchMedicineField = searchMedicineField;

        this.searchMedicineField.setOnKeyReleased(event -> {
    ...
    private void searchGenericMedicine() {
        String searchKey = searchMedicineField.getText().toLowerCase();
