...
public class FXMLMedicineController implements Initializable {
    ...
    private void openBrandMedicine() {
        try {
            ...
            fxmlMedicineBrandController.setSearchUtility(searchMedicineField, searchMedicineButton);
    ...
    private void openGenericMedicine() {
        try {
            ...
            fxmlMedicineGenericController.setSearchUtility(searchMedicineField, searchMedicineButton);
