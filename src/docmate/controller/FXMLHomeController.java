...
public class FXMLHomeController implements Initializable {
    ...
    @FXML
    private ProgressIndicator totalPatientProgress;
    @FXML
    ...
    @FXML
    private ProgressIndicator totalPrescriptionProgress;
    @FXML
    ...
    @FXML
    private ProgressIndicator totalMedicineProgress;
    @FXML
    ...
    private void setTotal() {
        new Thread(new Task<Void>() {
            ...
            protected void updateValue(Void value) {
                ...
                totalPatientProgress.setVisible(false);
                totalPrescriptionProgress.setVisible(false);
                totalMedicineProgress.setVisible(false);

                totalPatientText.setVisible(true);
                totalPrescriptionText.setVisible(true);
                totalMedicineText.setVisible(true);
            }
        }).start();
    }
